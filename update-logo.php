...
move_uploaded_file($_FILES["image1"]["tmp_name"],"logo/".$_FILES["image1"]["name"]);	$sql=mysqli_query($con,"update logo set logo='$image1' where id='1' ");
...
<div class="controls">
<input type="text"    name="image1"  readonly value="<?php echo htmlentities($row['logo']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="logo/<?php echo htmlentities($row['logo']);?>" width="200" height="100"> 
</div>
</div>
