...
move_uploaded_file($_FILES["image1"]["tmp_name"],"payment/".$_FILES["image1"]["name"]);	$sql=mysqli_query($con,"update paymentdetails set qrcode='$image1' where id='1' ");
...
<div class="controls">
<input type="text"    name="image1"  readonly value="<?php echo htmlentities($row['qrcode']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="payment/<?php echo htmlentities($row['qrcode']);?>" width="200" height="100"> 
</div>
</div>
