...
if($row1=mysqli_fetch_array($query1))
{
    ?>
                                    ...
                                    <a class="product-add"href="compare.php?pid=<?php echo $row['pid']; ?>&&action=add"><i class="fas fa-shopping-basket"></i>                                    <span>add</span>
</a>
                                        ...
                                        <td class="table-action">
                                            ...
                                            <a class="wish" href="compare.php?pid=<?php echo htmlentities($row['pid'])?>&&action=wishlist" title="Add to Wishlist"><i class="icofont-heart"></i></a>
                                        </td>
                                    </tr>
...
while($row4=mysqli_fetch_array($query4))
{
    ?>                                     
                                    ...
                                    <div class="view-action-group">
                                            <a class="wish" href="compare.php?pid=<?php echo htmlentities($row['pid'])?>&&action=wishlist" title="Add to Wishlist"><i class="icofont-heart"></i></a>
                                            <a class="wish" href="compare.php?pid=<?php echo htmlentities($row['pid'])?>&&action=compare" title="Add to Wishlist"><i class="icofont-random"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
