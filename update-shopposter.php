...
if(isset($_POST['submit']))
{
	...
	if($image1==null){
$sql=mysqli_query($con,"update shopposter set link='$link' where id='$id' ");
	}
	else{
move_uploaded_file($_FILES["image1"]["tmp_name"],"homeposter/".$_FILES["image1"]["name"]);	
$sql=mysqli_query($con,"update shopposter set link='$link',image='$image1' where id='$id' ");
...
$query=mysqli_query($con,"select * from shopposter where id='$id' ");
$cnt=1;
