...
$sql=mysqli_query($con,"insert into contacttypes(type) values('$type')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from contacttype where id = '".$_GET['id']."'");
...
<?php $query=mysqli_query($con,"select * from contacttypes");
$cnt=1;
