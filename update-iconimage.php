...
move_uploaded_file($_FILES["image1"]["tmp_name"],"logo/".$_FILES["image1"]["name"]);	
$sql=mysqli_query($con,"update iconbox set logo='$image1' where id='$id' ");
...
$query=mysqli_query($con,"select * from iconbox where id='$id' ");
$cnt=1;
