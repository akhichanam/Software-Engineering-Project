...
move_uploaded_file($_FILES["image1"]["tmp_name"],"breadcrumbanner/".$_FILES["image1"]["name"]);	$sql=mysqli_query($con,"update breadcrumbanner set image='$image1' where id='1' ");
...
<div class="controls">
<input type="text"    name="image1"  readonly value="<?php echo htmlentities($row['image']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="breadcrumbanner/<?php echo htmlentities($row['image']);?>" width="200" height="100"> 
</div>
</div>
