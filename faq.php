...
$sql=mysqli_query($con,"insert into faq(title,description) values('$title','$description')");
$_SESSION['msg']="FAQ Added Created !!";

}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from faq where id = '".$_GET['id']."'");
...
<?php $query=mysqli_query($con,"select * from faq");
$cnt=1;
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['description'])?></td>
																						<td>
											<a href="faq.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>			
							</tr>
										<?php $cnt=$cnt+1; } ?>
