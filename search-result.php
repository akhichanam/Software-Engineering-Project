        ...
        <?php } ?>
            <div class="container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $_GET['product']; ?></li>
                </ol>
            </div>
        </section>
        <!--=====================================
...
<div class="widget widget-brands" style="display:none;">
								...
								<div class="widget-title">
									<h3><span class="active">Products</span></h3>
								</div>
		...
		<input type="checkbox" id="cat" class="common_selector productss" style="
        
          accent-color: red;
        
    " value="<?php echo $find; ?>"  > <label><?php echo $find; ?></label>
										</li>
									</ul>
								</div>
...
<?php 
                    ...
                    $queryprice = mysqli_query($con,"SELECT discountprice FROM product where name like '$find' ");
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,discountprice,id FROM product where name like '$find' group by discountprice ";
...
<?php } ?>
    ...
    <?php 
                    ...
                    $queryprice = mysqli_query($con,"SELECT categoryid FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
?>
                        ...
                        <div class="shop-widget">
                            <h6 class="shop-widget-title">Filter by Category<a style="float:right;" onclick="open3()">+</a></h6>
                                <ul id="f3"  class="shop-widget-list shop-widget-scroll">
<?php

                    $query = "SELECT * FROM product where name like '$find' group by categoryid ORDER BY id ASC ";
                    ...
                    ?>
                                    <li class="check-box">
                                        <div class="shop-widget-content">
                                            <input type="checkbox" id="check3<?php echo $cnt;?>" class="common_selector categoryy" value="<?php echo $row['categoryid']; ?>">
<label for="check3<?php echo $cnt;?>"> <?php echo $row['categoryid']; ?></label>                                        </div>
                                        <span class="shop-widget-number">(<?php
                                        
                                        $id=$row['categoryid'];
$ret=mysqli_query($con,"select * from product where categoryid='$id' and name like '$find' ");
...
?>)</span>
    ...
    <?php 
                    ...
                    $queryprice = mysqli_query($con,"SELECT subcategoryid FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT * FROM product where name like '$find' group by subcategoryid ORDER BY id ASC ";
...
$ret=mysqli_query($con,"select * from product where subcategoryid='$id' and name like '$find' ");
$num=mysqli_num_rows($ret);
...
?>)</span>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT subcategoryid1 FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['subcategoryid1']==null){
...
?>
                        ...
                        <div class="shop-widget">
                            <h6 class="shop-widget-title">Filter by Sub Category<a style="float:right;" onclick="open4()">+</a></h6>
                                <ul id="f4"  class="shop-widget-list shop-widget-scroll">
<?php

                    $query = "SELECT * FROM product where name like '$find' group by subcategoryid1 ORDER BY id ASC ";
                    ...
                    ?>
                                    <li class="check-box">
                                        <div class="shop-widget-content">
                                            <input type="checkbox" id="check4<?php echo $cnt;?>" class="common_selector subcategoryy1" value="<?php echo $row['subcategoryid1']; ?>">
<label for="check4<?php echo $cnt;?>"> <?php echo $row['subcategoryid1']; ?></label>                                        </div>
                                        <span class="shop-widget-number">(<?php
                                        
                                        $id=$row['subcategoryid1'];
$ret=mysqli_query($con,"select * from product where subcategoryid1='$id' and name like '$find' ");
$num=mysqli_num_rows($ret);
...
?>)</span>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT brand FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['brand']==null){
...
<?php
                    ...
                    $query = "SELECT * FROM product where  name like '$find' group by brand ORDER BY id ASC ";
...
<label for="check5<?php echo $cnt;?>"> <?php echo $row['brand']; ?></label>                                        </div>
                                        ...
                                        $id=$row['brand'];
$ret=mysqli_query($con,"select * from product where brand='$id' and name like '$find' ");
$num=mysqli_num_rows($ret);
...
?>)</span>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT stock FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['stock']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,stock,id from product where name like '$find' group by stock ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check6<?php echo $cnt;?>">  <?php if($row['stock']==null){echo "NONE";}else{ echo $row['stock'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT motherboardchipset FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,motherboardchipset,id from product where name like '$find' group by motherboardchipset ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check7<?php echo $cnt;?>">  <?php if($row['motherboardchipset']==null){echo "NONE";}else{ echo $row['motherboardchipset'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT memory FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['memory']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,memory,id from product where name like '$find' group by memory ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check8<?php echo $cnt;?>">  <?php if($row['memory']==null){echo "NONE";}else{ echo $row['memory'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cpucollertype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cpucollertype,id from product where name like '$find' group by cpucollertype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check9<?php echo $cnt;?>">  <?php if($row['cpucollertype']==null){echo "NONE";}else{ echo $row['cpucollertype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT watt FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['watt']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,watt,id from product where name like '$find' group by watt ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check10<?php echo $cnt;?>">  <?php if($row['watt']==null){echo "NONE";}else{ echo $row['watt'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cpugeneration FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cpugeneration,id from product where name like '$find' group by cpugeneration ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check11<?php echo $cnt;?>">  <?php if($row['cpugeneration']==null){echo "NONE";}else{ echo $row['cpugeneration'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cpusocket FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['cpusocket']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cpusocket,id from product where name like '$find' group by cpusocket ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check12<?php echo $cnt;?>">  <?php if($row['cpusocket']==null){echo "NONE";}else{ echo $row['cpusocket'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT ramspeed FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['ramspeed']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,ramspeed,id from product where name like '$find' group by ramspeed ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check13<?php echo $cnt;?>">  <?php if($row['ramspeed']==null){echo "NONE";}else{ echo $row['ramspeed'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cabinetfantype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cabinetfantype,id from product where name like '$find' group by cabinetfantype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check14<?php echo $cnt;?>">  <?php if($row['cabinetfantype']==null){echo "NONE";}else{ echo $row['cabinetfantype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT motherboardgeneration FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,motherboardgeneration,id from product where name like '$find' group by motherboardgeneration ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check15<?php echo $cnt;?>">  <?php if($row['motherboardgeneration']==null){echo "NONE";}else{ echo $row['motherboardgeneration'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT ramcapacity FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,ramcapacity,id from product where name like '$find' group by ramcapacity ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check16<?php echo $cnt;?>">  <?php if($row['ramcapacity']==null){echo "NONE";}else{ echo $row['ramcapacity'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT hddformfactor FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,hddformfactor,id from product where name like '$find' group by hddformfactor ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check17<?php echo $cnt;?>">  <?php if($row['hddformfactor']==null){echo "NONE";}else{ echo $row['hddformfactor'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT graphiccardmemory FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,graphiccardmemory,id from product where name like '$find' group by graphiccardmemory ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check18<?php echo $cnt;?>">  <?php if($row['graphiccardmemory']==null){echo "NONE";}else{ echo $row['graphiccardmemory'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cpuseries FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['cpuseries']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cpuseries,id from product where name like '$find' group by cpuseries ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check19<?php echo $cnt;?>">  <?php if($row['cpuseries']==null){echo "NONE";}else{ echo $row['cpuseries'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT externalhddtypes FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,externalhddtypes,id from product where name like '$find' group by externalhddtypes ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check20<?php echo $cnt;?>">  <?php if($row['externalhddtypes']==null){echo "NONE";}else{ echo $row['externalhddtypes'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT internalhddcapacity FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,internalhddcapacity,id from product where name like '$find' group by internalhddcapacity ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check21<?php echo $cnt;?>">  <?php if($row['internalhddcapacity']==null){echo "NONE";}else{ echo $row['internalhddcapacity'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT graphiccardcapacity FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,graphiccardcapacity,id from product where name like '$find' group by graphiccardcapacity ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check22<?php echo $cnt;?>">  <?php if($row['graphiccardcapacity']==null){echo "NONE";}else{ echo $row['graphiccardcapacity'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT externalhddinterface FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,externalhddinterface,id from product where name like '$find' group by externalhddinterface ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check23<?php echo $cnt;?>">  <?php if($row['externalhddinterface']==null){echo "NONE";}else{ echo $row['externalhddinterface'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cabinetcasetype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cabinetcasetype,id from product where name like '$find' group by cabinetcasetype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check24<?php echo $cnt;?>">  <?php if($row['cabinetcasetype']==null){echo "NONE";}else{ echo $row['cabinetcasetype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT powercapacity FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,powercapacity,id from product where name like '$find' group by powercapacity ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check25<?php echo $cnt;?>">  <?php if($row['powercapacity']==null){echo "NONE";}else{ echo $row['powercapacity'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT rammemorytype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,rammemorytype,id from product where name like '$find' group by rammemorytype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check26<?php echo $cnt;?>">  <?php if($row['rammemorytype']==null){echo "NONE";}else{ echo $row['rammemorytype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT motherboardseries FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,motherboardseries,id from product where name like '$find' group by motherboardseries ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check27<?php echo $cnt;?>">  <?php if($row['motherboardseries']==null){echo "NONE";}else{ echo $row['motherboardseries'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT smpswatt FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['smpswatt']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,smpswatt,id from product where name like '$find' group by smpswatt ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check28<?php echo $cnt;?>">  <?php if($row['smpswatt']==null){echo "NONE";}else{ echo $row['smpswatt'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT ramtype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['ramtype']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,ramtype,id from product where name like '$find' group by ramtype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check29<?php echo $cnt;?>">  <?php if($row['ramtype']==null){echo "NONE";}else{ echo $row['ramtype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT smpscertification FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,smpscertification,id from product where name like '$find' group by smpscertification ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check30<?php echo $cnt;?>">  <?php if($row['smpscertification']==null){echo "NONE";}else{ echo $row['smpscertification'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT internalhddtype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,internalhddtype,id from product where name like '$find' group by internalhddtype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check31<?php echo $cnt;?>">  <?php if($row['internalhddtype']==null){echo "NONE";}else{ echo $row['internalhddtype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT externalhddcapacity FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,externalhddcapacity,id from product where name like '$find' group by externalhddcapacity ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check32<?php echo $cnt;?>">  <?php if($row['externalhddcapacity']==null){echo "NONE";}else{ echo $row['externalhddcapacity'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT interface FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['interface']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,interface,id from product where name like '$find' group by interface ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check33<?php echo $cnt;?>">  <?php if($row['interface']==null){echo "NONE";}else{ echo $row['interface'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT graphiccardseries FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,graphiccardseries,id from product where name like '$find' group by graphiccardseries ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check34<?php echo $cnt;?>">  <?php if($row['graphiccardseries']==null){echo "NONE";}else{ echo $row['graphiccardseries'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT ledlighting FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,ledlighting,id from product where name like '$find' group by ledlighting ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check35<?php echo $cnt;?>">  <?php if($row['ledlighting']==null){echo "NONE";}else{ echo $row['ledlighting'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT motherboardcompatibility FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,motherboardcompatibility,id from product where name like '$find' group by motherboardcompatibility ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check36<?php echo $cnt;?>">  <?php if($row['motherboardcompatibility']==null){echo "NONE";}else{ echo $row['motherboardcompatibility'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT threedrivebays FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,threedrivebays,id from product where name like '$find' group by threedrivebays ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check37<?php echo $cnt;?>">  <?php if($row['threedrivebays']==null){echo "NONE";}else{ echo $row['threedrivebays'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT twodrivebays FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,twodrivebays,id from product where name like '$find' group by twodrivebays ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check38<?php echo $cnt;?>">  <?php if($row['twodrivebays']==null){echo "NONE";}else{ echo $row['twodrivebays'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT formfactor FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,formfactor,id from product where name like '$find' group by formfactor ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check39<?php echo $cnt;?>">  <?php if($row['formfactor']==null){echo "NONE";}else{ echo $row['formfactor'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT graphiccompatibility FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,graphiccompatibility,id from product where name like '$find' group by graphiccompatibility ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check40<?php echo $cnt;?>">  <?php if($row['graphiccompatibility']==null){echo "NONE";}else{ echo $row['graphiccompatibility'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT cpusupport FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,cpusupport,id from product where name like '$find' group by cpusupport ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check41<?php echo $cnt;?>">  <?php if($row['cpusupport']==null){echo "NONE";}else{ echo $row['cpusupport'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT chipset FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['chipset']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,chipset,id from product where name like '$find' group by chipset ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check42<?php echo $cnt;?>">  <?php if($row['chipset']==null){echo "NONE";}else{ echo $row['chipset'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT memorysupporttype FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,memorysupporttype,id from product where name like '$find' group by memorysupporttype ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<label for="check43<?php echo $cnt;?>">  <?php if($row['memorysupporttype']==null){echo "NONE";}else{ echo $row['memorysupporttype'];} ?></label>                                        </div>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT motherboardplateform FROM product where name like '$find' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,motherboardplateform,id from product where name like '$find' group by motherboardplateform ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<?php $sql11=mysqli_query($con,"select * from product where name like '$find' ");
