...
$query=mysqli_query($con,"SELECT * FROM user WHERE email='$email1' and otpconfirmed='$otp'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update user set password='$password' WHERE email='$email1' and otpconfirmed='$otp' ");
header("location:login.php");
}
else
{
                            	echo "<script>alert('Wrong Email/OTP Please Renter proper');</script>";
                    ...
                    <div class="col-12 col-sm-10 col-md-12 col-lg-12 col-xl-10">
                        <div class="user-form-card">
                            <div class="user-form-title">
                                ...
                                <p>Request OTP with our secured System</p>
                            </div>
