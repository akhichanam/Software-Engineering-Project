...
$query=mysqli_query($con,"select * from subcategory where id='$cid1'");
...
<?php 
                    ...
                    $queryprice = mysqli_query($con,"SELECT discountprice FROM product where subcategoryid='$cid' ");
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,discountprice,id FROM product where subcategoryid='$cid' group by discountprice ";
...
<?php
                    ...
                    $query = "SELECT * FROM product where subcategoryid='$cid' ORDER BY id ASC ";
                    ...
                    ?>
                                    <li class="check-box">
                                        <div class="shop-widget-content">
                                            <input type="checkbox" id="cat" class="common_selector subcategoryy" value="<?php echo $row['subcategoryid']; ?>">
<label for="cat"> <?php echo $row['subcategoryid']; ?></label>                                        </div>
                                        <span class="shop-widget-number">(<?php
                                        
                                        $id=$row['subcategoryid'];
$ret=mysqli_query($con,"select * from product where subcategoryid='$cid'  ");
...
?>)</span>
  ...
  <?php                      $queryprice = mysqli_query($con,"SELECT brand FROM product where subcategoryid='$cid' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['brand']==null){
...
<?php
                    ...
                    $query = "SELECT * FROM product where  subcategoryid='$cid' group by brand ORDER BY id ASC ";
...
<label for="check5<?php echo $cnt;?>"> <?php echo $row['brand']; ?></label>                                        </div>
                                        ...
                                        $id=$row['brand'];
$ret=mysqli_query($con,"select * from product where brand='$id' and subcategoryid='$cid' ");
$num=mysqli_num_rows($ret);
...
?>)</span>
  ...
  <?php }                     $queryprice = mysqli_query($con,"SELECT stock FROM product where subcategoryid='$cid' ");
$pricecount=mysqli_num_rows($queryprice);
$pricec=0;
while($r=mysqli_fetch_array($queryprice)){
    if($r['stock']==null){
...
<?php
                    ...
                    $query = "SELECT Count(*) as discountcount,stock,id from product where subcategoryid='$cid' group by stock ";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    $cnt=1;
...
<?php $sql11=mysqli_query($con,"select * from product where subcategoryid='$cid' ");
