...
$sql=mysqli_query($con,"insert into menu1(name,link) values('$name','$link')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from menu1 where id = '".$_GET['id']."'");
...
<?php $query=mysqli_query($con,"select * from menu1");
$cnt=1;
...
?>									
										<tr>
											...
											<td>
											<a href="menu1.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>									</tr>
										<?php $cnt=$cnt+1; } ?>
