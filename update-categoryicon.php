...
if(isset($_POST['submit']))
{
	...
	if($image1==null){
$sql=mysqli_query($con,"update category set link='$link' where id='$id' ");
	}
	else{
move_uploaded_file($_FILES["image1"]["tmp_name"],"category/".$_FILES["image1"]["name"]);	
$sql=mysqli_query($con,"update category set icon='$image1' where id='$id' ");
...
<div class="controls">
<img src="category/<?php echo htmlentities($row['icon']);?>" width="200" height="100"> 
</div>
</div>
