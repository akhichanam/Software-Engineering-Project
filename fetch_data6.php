...
{
        $find=$_POST['productss'];
	$query = "
		SELECT product.*,productimage.image as pimg from product join productimage on productimage.productid=product.id   where product.name like '$find[0]'
	";
                            ...
                            <div class="col">
                                <div class="product-standard ">
                                    <div class="standard-media">
                                        <a class="standard-image" href="product-details.php?pid='. $row['id'] .'">
                                    ...
                                    <div class="standard-content">
                                        ...
                                        <h6 class="standard-price">
                                            <del>$'. $row['actualprice'] .'</del>
                                            <span>$'. $row['discountprice'] .'</span>
                                        </h6>
                                    <p class="standard-desc">'. $row['shortdescription'] .'</p>
...
<a class="standard-wish" title="Product Wishlist" href="index.php?pid='. $row['id'] .'&&action=wishlist" ><i class="fas fa-heart"></i>                                    <span>add to wishlist</span></a>
</div>
